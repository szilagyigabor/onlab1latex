...
\par A következőkben elkészítettem többféle BIFA variáció modelljét CST-ben, amiket később a paramétereik beállításával kihangoltam a kiválasztott bemeneti impedanciára. A variációk \aref{fig:bifa-variaciok}. ábrán láthatóak.
\begin{figure}[h]
	\centering
	\begin{subfigure}[b]{0.48\textwidth}
		\centering
		\includegraphics[draft]{kep/results/bifa.png}
		\caption{alsóbb rézréteg}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.48\textwidth}
		\centering
		\includegraphics[draft]{kep/results/bifa_bowtie.png}
		\caption{köztes réteg}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.48\textwidth}
		\centering
		\includegraphics[draft]{kep/results/bifa_broadband.png}
		\caption{felső rézréteg}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.48\textwidth}
		\centering
		\includegraphics[draft]{kep/results/bifa_meandered.png}
		\caption{felső rézréteg}
	\end{subfigure}
